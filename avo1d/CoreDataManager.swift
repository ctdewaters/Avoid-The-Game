...
public class DataManager: NSObject {
    ...
    lazy var managedObjectModel: NSManagedObjectModel = {
        ...
        let modelURL = NSBundle.mainBundle().URLForResource("avo1d", withExtension: "momd")!
    ...
    lazy var persistentStoreCoordinator: NSPersistentStoreCoordinator? = {
        ...
        let url = self.applicationDocumentsDirectory.URLByAppendingPathComponent("avo1d.sqlite")
    ...
    func saveObjectInEntity(entity: String, objects: Array<NSObject>?, keys: Array<String>?, deletePrevious: Bool){
        ...
        if deletePrevious == true{
            ...
            var events: NSArray!
            do {
                events = try context.executeFetchRequest(fetch)
            }
            catch {
                print(error)
            }
    ...
    func deleteObjectInEntity(entity: String, object: String, key: String){
        ...
        var objects: NSArray!
        do {
            objects = try context.executeFetchRequest(fetch)
        }
        catch {
            print(error)
        }
